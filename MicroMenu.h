...
extern "C" {
     ...
     */
    #define MENU_ITEM_STORAGE PROGMEM //SRAM

////////////////////////////////////////////ATTENTIONS!!!!!!!!!!!!!!!!!//////////////////////////////////////////
	#define MAX_SIZE_TEXT_FIELD 40 // define max size of text field in struct Menu_Item
	// because C++ dont work without it (is C its ok)
////////////////////////////////////////////ATTENTIONS!!!!!!!!!!!!!!!!!//////////////////////////////////////////
	...
	typedef const struct Menu_Item {
		...
		const char Text[MAX_SIZE_TEXT_FIELD]; /**< Menu item text to pass to the menu display callback function */
	} Menu_Item_t;
